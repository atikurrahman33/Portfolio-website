...
const Banner = () => {
  ...
  return (
    <>
      {/* Banner Section */}
    <section className="max-w-6xl w-full p-8 lg:p-12 grid lg:grid-cols-12 gap-8 mx-auto my-16 relative overflow-hidden">
  {/* Left Side */}
  <div className="lg:col-span-7 flex flex-col justify-center space-y-6 relative z-10">
    ...
    >
      ...
      <p className="text-blue-300 border-gray-800 text-4xl">
